$(function () {
    ...
    $option = $('.custom-select select > option');

    //on crée dans le dom une div de class "select-selected" et une div de class "select-items"
    $('<div class="select-selected">Select car :</div>').insertAfter('.custom-select select');
    ...
    $option.each(function () {
        ...
        // pour chaque option du select, on crée une div de classe"item" et on y injecte le texte de la balise option
